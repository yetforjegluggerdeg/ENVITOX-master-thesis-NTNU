...
\begin{figure}
    ...
    \begin{subfigure}[b]{.45\textwidth}
        ...
        \caption{Mussel grip and needle alignment seen from operators perspective.}
        \label{sfig:c}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{.45\textwidth}
        ...
        \caption{Mussel with visible posterior adductor muscle (red arrow) where mantel has been cut.}
        \label{sfig:d}
    \end{subfigure}
