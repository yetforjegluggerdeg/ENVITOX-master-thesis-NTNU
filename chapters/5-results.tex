...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/Gating strategy/Eosin exp blackwhite cropped.pdf}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/Eosin and Percoll exp/PERCOLL SEP II final.pdf}
...
15\%-33\% interface: FCM = 97\% basophils, microscopy = 96.14 \% basophils (7.72\% blast-like and 88.42\%) (= 3.86 \% eosinophils)
