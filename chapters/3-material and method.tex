...
Semrock Brightline\textsuperscript{\textregistered} Led-Cy5-A filtercube
B2A Ex: 450-490, DM: 500, Em: 515-
...
\begin{table}[H]
   ...
   Microscope camera                     & DS-Fi1c                  & Nikon \\
...
The slides were placed on the stage of a Nikon Eclipse 80i upright microscope, and 10-20 microscopic fields from each smear was photographed under DIC illumination with a $\times$60 oil immersion objective. Cell diameter measurements were performed digitally, using the \emph{Straight line tool} of the ImageJ image processing software (NIH, Bethesda, Maryland, US). The actual size of the magnified haemocytes were determined by calibrating the software's pixel/\micro m scale with a stage micrometer calibration slide (Leica Microsystems, Buffalo, US), photographed with the same equipment and image resolution as the haemolymph smears. When haemocyte outlines deviated from an approximate spherical shape, the diameter was estimated as the average length of the long and short axes, after Burkhard et al. (2009). The measurements were performed as differential counts, such that the number of measurements of each cell type reflected their average relative proportions (\%) across all 20 mussels.
...
To discriminate between viable and necrotic haemocytes by flow cytometry, a two-color fluorescence assay with the cell-permeant probe Calcein acetoxymethyl and the non-permeant dsDNA-binding dye TO-PRO$^{TM}$-3 Iodide (Molecular Probes, Eugene, OR) was chosen. This combination of probes was primarily chosen for two reasons: (1) it enables simultaneous measurement of intracellular esterase activity and plasma membrane integrity - two recognized parameters of cell viability, and (2) there is virtually no fluorescent spillover between the probes, such that the uncompensated raw data can be used directly.

Since Calcein AM is commonly used in the LIVE/DEAD\textsuperscript{\textregistered} Viability/Cytotoxicity Kit for mammalian cells (Molecular Probes, Eugene, OR), the staining protocol of this kit was used as a guide for obtaining an adequate fluorescent signal from hydrolyzed Calcein on the FL1 detector (518-548 nm) the flow cytometer. The manufacturer's recommendation of 1 \micro L 50 \micro M Calcein AM mL$^{-1}$ cell suspension (0.1-5 $\times 10^{6}$ cells) gave a bright fluorescent signal after 15 minutes incubation in the dark, and the staining procedure required therefore no more optimization. Information on the range of TO-PRO-3 Iodide concentrations suitable for flow cytometry was however sparse, such that this procedure had to be determined experimentally.

\subsubsection{Determination of optimal TO-PRO$^{TM}$-3 Iodide staining concentration}
The optimal TO-PRO$^{TM}$-3 Iodide concentrations for a flow cytometric dye exclusion assay would ideally fulfill two requirements. The first would be to give the highest possible resolution between viable and necrotic cells in terms of fluorescent intensity. Secondly, and of equal importance; the concentration cannot be acutely cytotoxic to haemocytes within the time-frame of staining and flow cytometric acquisition. To determine the range of concentration suitable for this assay, one pool of dead haemocytes (70\% methanol, 30 min) and one pool of fresh haemolymph in ACB (1:1) were prepared. The methanol-killed hameocytes were washed three times in MPSS and resuspended ACB, before the two pools were gently mixed (1:1). The suspension of freshly withdrawn and dead haemocytes were divided into 10 aliquotes of 1 mL, and each were stained with TO-PRO$^{TM}$-3 in a range of 30 nM to 8 \micro M. After incubating for 15 minutes in darkness, 10 000 events were acquired from each sample on the flow cytometer. To examine wether the fluorescent signal intensity increased with further incubation, the same samples were incubated for another 15 minutes before the measurement was repeated.

Red laser-exited fluorescence from dsDNA-bound TO-PRO$^{TM}$-3 Iodide was collected on the FL4 detector (675/25 nm) of the flow cytometer. A histogram representation of the fluorescence revealed two distinct populations of events: one population of ToPro3$^{dim}$ events and one population of ToPro3$^{bright}$ events. The mean fluorescent intensity (MFI) of the two populations were calculated for each aliquot, and the difference was plotted against the staining-concentrations of TO-PRO$^{TM}$-3 Iodide. Potential cytotoxicity at high concentrations was evaluated from the same parameter, as a cytotoxic effect would increase the MFI of the ToPro3$^{-}$ population, causing a decrease in MFI$_{ToPro3^{+}}$ - MFI$_{ToPro3^{-}}$.
