...
\subsection{Haemocyte medium: pH}

\begin{center}
\begin{longtable}{cccccc}
\caption{The buffer pH raw data longtable.} \label{tab:long_table3} \\
\hline
\multirow{2}{*}{Mussel ID} & \multirow{2}{*}{Buffer} & \multicolumn{4}{c}{Count} \\
...
\hline
\multirow{2}{*}{Method} & \multirow{2}{*}{Mussel ID} & \multicolumn{4}{c}{Count} \\
 && BB & BG & Eo & Total \\ 
\hline 
\endfirsthead
